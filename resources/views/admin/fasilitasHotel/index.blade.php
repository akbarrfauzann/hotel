            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-row-reverse">
                        <a class="btn btn-primary btn-lg mt-0 mb-3" href="/fasilitasHotel/create"><i
                        ...
                        <table class="table table-bordered" style="table-layout: fixed; width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 35%;" class="text-wrap"> Keterangan </th>
                            ...
                            <tbody>
                                @foreach ($fasilitasHotel as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('storage/' . $row->image) }}" alt="Fasilitas Hotel"
                                                style="border-radius: 0; width: 150px; height: 90px;">
                                        </td>
                                        <td>
                                            <button class="badge bg-info border-0"><a
                                                    href="{{ route('fasilitasHotel.edit', $row->id) }}"><i
