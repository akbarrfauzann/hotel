            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-row-reverse">
                        <a class="btn btn-primary btn-lg mt-0 mb-3" href="/dataKamar/create"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="badge bg-info border-0"><a
                                                    href="{{ route('dataKamar.edit', $row->id) }}"><i
                                                        class="mdi mdi-pencil"></i></a></button>
                                            &nbsp;
                                            <form action="{{ route('dataKamar.destroy', $row->id) }}" method="post"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
