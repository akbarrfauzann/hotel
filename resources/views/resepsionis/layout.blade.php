...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="/assets/homepage/img/hotel-icon.svg" />
    <style>
        .content-wrapper {
                ...
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul class="navbar-nav w-100">
                        <li class="nav-item w-100">
                            <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" action="/dataReservasi/search"
                                method="GET">
                                <input type="search" name="cari" class="form-control"
                                    placeholder="Cari nama tamu ..." autofocus value="{{ old('cari') }}">
